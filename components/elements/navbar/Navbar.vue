...
<template>
  ...
  >
    ...
    <nav class="flex w-3/4 justify-end items-center gap-3">
      <div class="w-full py-3 flex justify-center lg:justify-end gap-5 items-center border-t-2 lg:border-none fixed bottom-0 left-0 z-10 bg-white dark:bg-background lg:relative">
        <PageNav />
